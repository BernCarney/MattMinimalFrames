local mmfDefaults = {
    ...
    useSharedPartyRaidNameFont = false,
    centerPartyRaidNames = false,
    partyRaidNameOutline = false,
    partyRaidNameFontSize = 16,
    partyNameFontSize = 16,
    raidNameFontSize = 14,
    partyNameTruncateLength = 0,
    raidNameTruncateLength = 0,
    hidePartyFrameLabel = false,
